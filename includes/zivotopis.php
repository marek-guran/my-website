<article class="resume" data-page="životopis">
    ...
    <h3 class="h3 skills-title">Znalosti</h3>

        <?php include 'includes/zivotopis-it-znalosti.php'; ?>
        <div class="empty-space"></div>
        <?php include 'includes/zivotopis-programy-znalosti.php'; ?>
        <div class="empty-space"></div>
        <?php include 'includes/zivotopis-programovanie-znalosti.php'; ?>
